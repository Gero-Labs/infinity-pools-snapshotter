...
public class SwaggerConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        if (profile.equalsIgnoreCase("production")) {
            openApi = openApi.servers(List.of(new Server().url("https://snapshotter.infinitypools.io")));
        }
        return openApi.components(new Components())
                .info(new Info().title("Gero Labs Infinity Pools Snapshotter")
                        ...
                        .license(new License().name("Apache 2.0").url("https://snapshotter.infinitypools.io/")));
    }
}
