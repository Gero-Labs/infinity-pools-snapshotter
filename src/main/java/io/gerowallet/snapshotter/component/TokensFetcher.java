package io.gerowallet.snapshotter.component;
...
import io.gerowallet.snapshotter.config.SnapshotterProperties;
import io.gerowallet.snapshotter.utils.DateUtils;
...
public class TokensFetcher {
    ...
    private final MultiKeyMap<String, List<io.gerowallet.snapshotter.model.AssetAddress>> multiKeyMap = new MultiKeyMap<>();
    ...
    private void cleanup() throws ParseException {
        ...
        MapIterator<MultiKey<? extends String>, List<io.gerowallet.snapshotter.model.AssetAddress>> mapIterator = multiKeyMap.mapIterator();
    ...
    public boolean retrieveAssetAddressesData(long time, String policyId, int tryCount) {
        try {
            if (tryCount <= MAX_RETRIES) {
                ...
                List<io.gerowallet.snapshotter.model.AssetAddress> assetAddresses = new ArrayList<>();
                            ...
                            while (assetTryCount <= MAX_RETRIES && !success) {
                                try {
                                    ...
                                    if (!assetAddressesResult.isSuccessful()) {
                                        ...
                                        assetAddressesResult.getValue().forEach(assetAddress -> assetAddresses.add(new io.gerowallet.snapshotter.model.AssetAddress(assetAddress, policyAsset.getAsset())));
                                        success = true;
                                    }
    ...
    public List<io.gerowallet.snapshotter.model.AssetAddress> getAssetAddressesByPolicyId(long timestamp, String policyId) {
